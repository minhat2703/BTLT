    ...
    var detail = `
                <img src="${bookings[i].image}"  alt="..."  style="width: 100%"> 
                    <div id="details-1">
                        ...
                        <button class="form-control btn btn-success"  style="width: 30%" onclick="Back()">Back</button>
                    </div>
                </div>
            `
...
function Update(i) {
    ...
    document.getElementById('appBar').innerText = 'Sửa Booking'
    ...
    document.getElementById('Update').addEventListener('click', () => {
        ...
        document.getElementById('appBar').innerText = 'Thêm Booking'
        listBookings()
        resetForm()
    })
}